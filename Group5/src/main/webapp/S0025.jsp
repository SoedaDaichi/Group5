...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-9 offset-3">
				<div class="row my-4">
					<div class="col-2 text-end"><h5>販売日</h5></div>
					<div class="col-3">
				...
				<div class="row my-4">
					<div class="col-2 text-end"><h5>担当</h5></div>
					<div class="col-3">
				...
				<div class="row my-4">
					<div class="col-2 text-end"><h5>商品カテゴリー</h5></div>
					<div class="col-3">
				...
				<div class="row my-4">
					<div class="col-2 text-end"><h5><span class>商品名</span></h5></div>
					<div class="col-3">
				...
				<div class="row my-4">
					<div class="col-2 text-end"><h5><span class>単価</span></h5></div>
					<div class="col-3">
				...
				<div class="row my-4">
					<div class="col-2 text-end"><h5><span class>個数</span></h5></div>
					<div class="col-3">
				...
				<div class="row my-4">
					<div class="col-2 text-end"><h5><span class>備考</span></h5></div>
					<div class="col-3">
