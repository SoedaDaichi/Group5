		...
		<form id="create-sales-form" action="S0010.html" method="post">
			<div class=row>
				...
				<div class="col-2 my-3">
					<input type="date" id="date" name="saledate" class="form-control" required>
				</div>
			</div>
			<div class=row>
				<div class="col-2 text-end my-3">
			...
			<div class=row>
				...
				<div class="col-4 my-3">
					...
					id="exampleFormControlInput1" name="trade" placeholder="商品名" required>
				</div>
			</div>
			<div class=row>
				<div class="col-2 text-end my-3">
				...
				<div class="col-2 my-3">
					<input type="text" class="form-control" id="exampleFormControlInput1" name="unit_price" placeholder="単価" required>
				</div>
			</div>
			<div class=row>
				<div class="col-2 text-end my-3">
				...
				<div class="col-2 my-3">
					<input type="text" class="form-control" id="exampleFormControlInput1" name="sale_num" placeholder="個数" required>
				</div>
			</div>
			<div class=row>
				<div class="col-2 text-end my-3">
