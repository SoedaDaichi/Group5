...
public class ErrorService {
	...
	public Map<String, String> ValidateSales(String sale_dateStr, String account_idStr, String category_idStr,
			String trade, String unit_priceStr, String sale_numberStr, String note) {
		Map<String, String> errors = new HashMap<>();
		...
		if (S0010Service.ValidNull(trade)) {
			errors.put("trade", "商品名を入力してください。");
		} else if (trade.getBytes(StandardCharsets.UTF_8).length > 100) {
			errors.put("trade", "商品名が長すぎます。");
		}
